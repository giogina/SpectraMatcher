...
def set_font_registry(font_registry_tag: Union[int, str]):
...
class Attribute:
    attribute_connector: Union[AttributeConnector, None] = None
...
class LineAttribute(Attribute):
    ...
    def render(self, text_height: Union[float, int], parent=0, attributes_group=0):
        ...
...
class FontAttribute(Attribute):
    ...
    @classmethod
    def set_font(cls, path, size: Union[float, int]):
        cls.font_path = path
        cls._fonts = {}
    ...
    @classmethod
    def get_font(cls, size: Union[float, int] = None):
        if size is None:
            return cls.font
        size = math_round(size)
...
class HoverAttribute(Attribute):
    ...
    def __init__(self, attribute_connector: Union[AttributeConnector, None]):
    ...
    @classmethod
    def add_to_check_hover_items(cls, item: Union[int, str], callback=None):
