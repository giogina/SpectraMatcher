...
class Blockquote(LineAttribute):
    ...
    def render(self, text_height: Union[int, float], parent=0, attributes_group=0):
    ...
    @CallInNextFrame
    def self_post_render(self, text_height: Union[int, float], spacer_group: int, parent=0, attributes_group=0):
...
class List(LineAttribute):
    ...
    def get_task_width(self) -> Union[int, float]:
        width = 0
        if not self.task:
            return width
