...
class Url(HoverAttribute):
    color: list = (85, 135, 205, 255)
    line_color: list = (255, 255, 255, 0)
    hover_color: list = (153, 187, 255, 255)

    url: str

    dpg_text_objects: list
    underline_objects: list

    def __init__(self, url: str, attribute_connector: Union[AttributeConnector, None]):
